...
public static class SpriteTools // provided through class
{
    public static Vector3 ConstrainToScreenSimple(SpriteRenderer spriteRenderer)
    {
        Vector3 screenPosition = Camera.main.WorldToScreenPoint(spriteRenderer.transform.position); 
                                            // takes a world point and converts it to a screen point
        ...
        return Camera.main.ScreenToWorldPoint(screenPosition);
                            // takes a screen point and converts it to its world point
    }
    
    public static Vector3 ConstrainToScreen(SpriteRenderer spriteRenderer)
    {
        Vector3 screenPosition = Camera.main.WorldToScreenPoint(spriteRenderer.transform.position); // world to screen
